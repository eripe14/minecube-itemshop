package com.eripe14.itemshop.database;
...
public class DatabaseManager {
    ...
    public void connect() throws SQLException {
        ...
        DatabaseType databaseType = this.config.databaseSection.databaseType;
        ...
        this.dataSource.setUsername(this.config.databaseSection.username);
        this.dataSource.setPassword(this.config.databaseSection.password);

        switch (DatabaseType.valueOf(databaseType.toString().toUpperCase())) {

            case MYSQL -> {
                this.dataSource.setDriverClassName("com.mysql.cj.jdbc.Driver");
                this.dataSource.setJdbcUrl("jdbc:mysql://" + this.config.databaseSection.hostname + ":" + this.config.databaseSection.port + "/" + this.config.databaseSection.database);
            }

            case MARIADB -> {
                this.dataSource.setDriverClassName("org.mariadb.jdbc.Driver");
                this.dataSource.setJdbcUrl("jdbc:mariadb://" + this.config.databaseSection.hostname + ":" + this.config.databaseSection.port + "/" + this.config.databaseSection.database);
            }
            ...
            case POSTGRESQL -> {
                ...
                this.dataSource.setJdbcUrl("jdbc:postgresql://" + this.config.databaseSection.hostname + ":" + this.config.databaseSection.port + "/");
            }
